function plotMetricsSW(jobTags)

% plotMetricsSW(jobTag)
...
%
% Figure 5E: plotMetricsSW({'swRound1'})
...
for iMetric=1:length(metricNames)
    ...
    methods={'p2g','p2w','t2g','t2w','p20g','p20gsw','r'};
    ...
    namesByMethod('p20gsw')='PCA20 GMM SW';
    ...
    % Set ticks
    set(gca,'YTick',1:length(methods));
